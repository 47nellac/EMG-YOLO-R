...
class Conv(nn.Module):
    ...
    def forward(self, x):
        ...
        """
        print(f'Conv received {x.dim()}-size tensor')
...
class Concat(nn.Module):
    ...
    def forward(self, x):
        ...
        """
        for t in x:
            print(f'Concat received {t.dim()}-size tensor')        
...
class MAM(nn.Module):
    ...
    def forward(self, x):
        ...
        Returns:
            (torch.Tensor): Concatenated tensor.
        """
        print(f'MAM received {x.dim()}-size tensor')
        alpha = self.dw1(x)
...
class EMCM(nn.Module):
    ...
    def __init__(self, c1, c2):
        ...
        self.c_split = self.c // 4 # different hidden channels
        self.conv1 = Conv(c1, self.c, 1) # supposed to be 1x1, may be set up correctly now
        self.conv2 = Conv(self.c_split, self.c_split, 1) # supposed to be 1x1 Conv
        self.conv3 = Conv(self.c_split, self.c_split, 3) # supposed to be 3x3 Conv
    ...
    def forward(self, x):
        ...
        Returns:
            (torch.Tensor): Concatenated tensor.
        """
        print(f'EMCM received {x.dim()}-size tensor')
...
class C2fEMCM(nn.Module):
    ...
    def forward(self, x):
        ...
        """
        print(f'C2fEMCM received {x.dim()}-size tensor')
...
class CSPStage(nn.Module):
    ...
    def forward(self, x):
        ...
        Returns:
            (torch.Tensor): Concatenated tensor.
        """
        print(f'CSPStage received {x.dim()}-size tensor')
